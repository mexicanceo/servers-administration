...
echo "15 Create A Samba User"
echo "16 Delete A samba user "
echo "17 exit "
read opc
case $opc in
	"1")
...
echo "the file has not been modified"
	...
	;;
	"15")
	echo "Type the user to add to the samba enviroment"
        read usr
        smbpasswd $usr
        echo "The user $usr has been added!"
	;;
	 "16")
        echo "Type the user to remove to the samba enviroment"
        read usr
        smbpasswd -x $usr
        echo "The user $usr has been deleted!"
	;;
       	"17")
